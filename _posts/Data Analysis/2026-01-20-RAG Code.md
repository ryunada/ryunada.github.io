...
- 도메인 데이터(금융 약관)를 활용하여, LLaMA 3.1 모델이 복잡한 문맥을 어떻게 검색(Retrieval)하고 정교한 답변을 생성(Generation)하는지를 검증
...
## III-III. QA Generation Function
...
- ❗️ Caution
    - 생성된 Q/A는 encoding되어 있어 open할 때 `+ encoding = 'cp949'`를 해줘야 한다. 
